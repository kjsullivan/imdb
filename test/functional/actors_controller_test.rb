...
class ActorsControllerTest < ActionController::TestCase
  ...
  test "should create actor" do
    assert_difference('Actor.count') do
      post :create, actor: { dob: @actor.dob, hometown: @actor.hometown, name: @actor.name, photo_url: @actor.photo_url }
    end
  ...
  test "should update actor" do
    put :update, id: @actor, actor: { dob: @actor.dob, hometown: @actor.hometown, name: @actor.name, photo_url: @actor.photo_url }
    assert_redirected_to actor_path(assigns(:actor))
  end
